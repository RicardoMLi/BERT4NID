...
def finetune_opts(parser):
    ...
    parser.add_argument("--output_model_path", default="checkpoints/finetune_bert.bin", type=str,
    ...
    parser.add_argument("--config_path", default="configs/bert/medium_config.json", type=str,
