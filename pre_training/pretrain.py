...
from uer.trainer import train_and_validate
...
def main():
    ...
    # Path options.
    parser.add_argument("--dataset_path", type=str, default="datasets/pre_training_dataset_bert.pt",
    ...
    parser.add_argument("--config_path", type=str, default="configs/bert/medium_config.json",
    ...
    # GPU options.
    parser.add_argument("--world_size", type=int, default=2, help="Total number of processes (GPUs) for training.")
    parser.add_argument("--gpu_ranks", default=[0, 1], nargs='+', type=int, help="List of ranks of each process."
