...
class CNN(LightningModule):
    def __init__(
        ...
        print("max pool out shape", max_pool_out)
    ...
    def forward(self, x):
        ...
        x = x.reshape(batch_size, -1)  # shape ==> [bs, 8600]
    ...
    def train_dataloader(self):
        ...
        dataset_dict = datasets.load_dataset(self.hparams.data_path, cache_dir='/data3/wzy/hyy/lzy')
