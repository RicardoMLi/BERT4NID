    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if accuracy >= accuracy_max:
                torch.save(model.state_dict(), os.path.join(save_dir_model, "Amodel_CNN_CTU_max.pth"))
...
def test():
    ...
    model_test.load_state_dict(torch.load(os.path.join(save_dir_model, "Amodel_CNN_CTU_max.pth")))
